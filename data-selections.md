...
### regexp
Selects all records that match a regular expression (https://en.wikipedia.org/wiki/Regular_expression). The set of supported operators is listed below (See https://github.com/cesanta/slre):
...
<img srd="img/44.jpg" style="max-width: 50%">
